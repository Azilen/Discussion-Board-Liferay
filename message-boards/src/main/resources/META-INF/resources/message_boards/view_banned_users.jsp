...
<div class="main-content-body">
	<%
		int size=CustomThreadCategoryList.getBannedUsersList(request).size();
	%>
	...
	>
		<liferay-ui:search-container-results>
						<%
							//Custom list for banned users 
								List<MBBan> userResults = CustomThreadCategoryList.getBannedUsersList(request);
								results = ListUtil.subList(userResults,searchContainer.getStart(),searchContainer.getEnd());
								total = userResults.size();
