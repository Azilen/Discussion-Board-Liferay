...
<div class="lfr-search-container <%= resultRows.isEmpty() ? "hide" : StringPool.BLANK %>">
	...
	<div id="<%= namespace + id %>SearchContainer">
		...
		<c:if test="<%= headerNames != null %>">
			...
			<thead class="table-columns column-style">
				<tr>
				...
				for (int i = 0; i < headerNames.size(); i++) {
					...
					String columnHeaderStyle=StringPool.BLANK;
					
					if(namespace!=null && namespace.equals("_19_"))
						columnHeaderStyle="text-transform: uppercase;font-weight: normal;";
					...
					if (headerNames.size() == 1) {
						...
						columnHeaderStyle="text-transform: uppercase;font-weight: 500;";
					}
					...
					if(headerName!=null &&(headerName.equals("categories[message-board]")||headerName.equals("threads")||headerName.equals("posts")||headerName.equals("flag")||headerName.equals("started-by")||headerName.equals("posts")||headerName.equals("views") ||headerName.equals("categories")||headerName.equals("ban-date")||headerName.equals("unban-date")||headerName.equals("banned-by")))
						cssClass +=" hide-category-column";
					
					
					if(headerName!=null &&(headerName.equals("last-post")))
						cssClass +=" lastpost_CT_MB";
				...
				%>
					...
					<th class="<%= cssClass %>" id="<%= namespace + id %>_col-<%= normalizedHeaderName %>" style="<%=columnHeaderStyle %>" 
		...
		String btnClass="";
		if(namespace!=null && namespace.equals("_19_"))
			btnClass="btn-hide-text";
		%>
				
		<tbody class="table-data <%=btnClass %>">
		...
		for (int i = 0; i < resultRows.size(); i++) {
			...
			String rowBGColor="";
			if(namespace!=null && namespace.equals("_19_"))
				rowBGColor="background: #f9f9f9;";
		%>

			<tr class="<%= GetterUtil.getString(row.getClassName()) %> <%= rowIsChecked ? "info" : StringPool.BLANK %>" <%= AUIUtil.buildData(data) %> style="<%=rowBGColor%>">
			...
			for (int j = 0; j < entries.size(); j++) {
				...
				String actionColumnStyle="";
				
				
				if(normalizedHeaderName!=null && (normalizedHeaderName.equals("ban-date")||normalizedHeaderName.equals("unban-date")))
					actionColumnStyle="vertical-align: middle;";
				...
				if (entries.size() == 1) {
					...
					if(namespace!=null && (id!=null && (!id.equals("mbBansSearchContainer"))) && columnClassName!=null &&(namespace.equals("_19_")&& columnClassName.contains("last")))
					{	
						actionColumnStyle="vertical-align: middle; text-align: right; width: 6%;";
					}
					else if(namespace!=null && (id!=null && (id.equals("mbBansSearchContainer"))) && columnClassName!=null &&(namespace.equals("_19_")&& columnClassName.contains("last")))
					{
						actionColumnStyle="vertical-align: middle;";
					}
				}
				...
				if(normalizedHeaderName!=null &&(normalizedHeaderName.equals("categories-message-board-")||normalizedHeaderName.equals("threads")||normalizedHeaderName.equals("posts")||normalizedHeaderName.equals("flag")||normalizedHeaderName.equals("started-by")||normalizedHeaderName.equals("posts")||normalizedHeaderName.equals("views"))||normalizedHeaderName.equals("categories")||normalizedHeaderName.equals("ban-date")||normalizedHeaderName.equals("unban-date")||normalizedHeaderName.equals("banned-by"))
					columnClassName +=" hide-category-column";
			...
			%>
				...
				<td class="table-cell <%= columnClassName %>" style="<%=actionColumnStyle%>">
