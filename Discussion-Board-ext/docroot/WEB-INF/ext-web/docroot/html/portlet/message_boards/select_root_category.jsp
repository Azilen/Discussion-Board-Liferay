...
PortletURL portletURLObj = renderResponse.createRenderURL();
portletURLObj.setParameter("struts_action", "/message_boards/select_category");
portletURLObj.setWindowState(LiferayWindowState.POP_UP);
...
if(categoryId==0)
{
	//category=null;
		...
		PortalUtil.addPortletBreadcrumbEntry(
			...
			portletURLObj.toString());
}
else
{
	category=MBCategoryLocalServiceUtil.fetchMBCategory(categoryId);
	List portletBreadcrumbList = PortalUtil.getPortletBreadcrumbList(request);
...
MBCategory mbCategory=MBCategoryLocalServiceUtil.fetchMBCategory(categoryId);
...
<aui:form method="post" name="selectCategoryFm">
	...
	portletURL.setParameter("struts_action", "/portlet_configuration/select_category");
	...
	>
		...
		>
			...
			<portlet:renderURL var="rowURL">
				<portlet:param name="struts_action" value="/portlet_configuration/select_category" />
